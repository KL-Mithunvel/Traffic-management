...
defaultGreen = {0: 10, 1: 10, 2: 10, 3: 10, 4: 10, 5: 10}
defaultRed = 150
defaultYellow = 5
...
x = {'right': [0, 0, 0], 'down': [455, 427, 397], 'left': [1400, 1400, 1400], 'up': [252, 257, 297]}
y = {'right': [158, 180, 208], 'down': [0, 0, 0], 'left': [378, 346, 316], 'up': [800, 800, 800]}
...
signalCoods = [(180, 40), (530, 40), (530, 420), (180, 420), (970, 420), (1300, 110)]
signalTimerCoods = [(160, 40), (510, 40), (510, 420), (160, 420), (950, 420), (1280, 120)]

# Coordinates of stop lines
stopLines = {'right': 250, 'down': 130, 'left': 500, 'up': 415}
defaultStop = {'right': 240, 'down': 120, 'left': 510, 'up': 425}
...
def initialize():
    ...
    if (randomGreenSignalTimer):
        ...
        signals.append(ts4)
        ts5 = TrafficSignal(defaultRed, defaultYellow, random.randint(minTime, maxTime))
        signals.append(ts3)
        ts6 = TrafficSignal(defaultRed, defaultYellow, random.randint(minTime, maxTime))
        signals.append(ts4)
    else:
        ...
        ts5 = TrafficSignal(defaultRed, defaultYellow, defaultGreen[4])
        signals.append(ts5)
        ts6 = TrafficSignal(defaultRed, defaultYellow, defaultGreen[5])
        signals.append(ts6)
        repeat()
